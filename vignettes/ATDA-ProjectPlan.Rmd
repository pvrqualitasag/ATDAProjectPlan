...
objSecEnum$displayNumSection()
```
Für dieses Projekt `ATDA-ASR` sind vorerst drei Arten des Datentransfers vorstellbar. Nach dem Treffen mit den Herstellern der Melkanlagen am 18.3.2016 werden wir uns für eine der drei folgenden oder eine hier noch nicht beschriebene Variante entscheiden. Die eine Variante der Wahl wird im Projekt `ATDA-ASR` umgesetzt werden.
...
\begin{center}
\includegraphics[width=0.8\textwidth]{Schaubild_ATDA_Cloud}
\end{center}
...
objSecEnum$displayNumSection()
```
Die Tabelle am Ende dieses Dokuments zeigt einen ungefähren Plan, wie sich die bis zu aktuellen Zeitpunkt bekannten Themen auf das erste Halbjahr 2016 aufteilen lassen. __Wichtig__ ist die Tatsache, dass dieser Projektpan nicht abschliessend ist und somit das Projekt nicht Mitte 2016 abgeschlossen sein wird. Der Plan erstreckt sich nur über die erste Hälfte vom Jahr 2016, weil wir aufgrund des aktuellen Informationsstandes den weiteren Projektverlauf für das zweite Halbjahr 2016 aktuell noch nicht planen können. 
