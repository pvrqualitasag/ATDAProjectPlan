...
objSecEnum$displayNumSection()
```
`NDX` steht für Nordic Data Exchange`r r6ob_abbrtable$add_abbrev(psAbbrev = "NDX", psMeaning = "Nordic Data Exchange", pbOut = FALSE)`. NDX ist ein Projekt, welches den Datenaustausch in den skandinavischen Ländern automatisiert. Von Seiten der Hersteller sind Lely und DeLaval beteiligt. 
...
rmddochelper::insertOdsAsPdf(psOdsFileStem = "ProjektAblaufplanQ4", 
