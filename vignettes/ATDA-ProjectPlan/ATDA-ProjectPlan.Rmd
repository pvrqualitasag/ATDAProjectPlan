...
BvL hat sich bereit erklärt, die Ansprechsperson für Fragen betreffend des holländischen Datenaustauschprojekts zu sein. Er klärt CRV-intern ab, ob und in welchem Umfang eine Zusammenarbeit zwischen diesem Projekt `ATDA-ASR` und CRV-Holland möglich ist. Für uns ist es wichtig die Frage zu klären, ob die PlugIns der verschiedenen Anbieter, welche in Holland eingesetzt werden auch auf den Betrieben in der Schweiz eingesetzt werden können.

Falls die PlugIns aus dem Projekt von CRV in Holland für uns nicht verfügbar sind, müssen wir die Funktionalität des Datenexports aus dem ISL selber umgesetzen. Für eine eigene Umsetzung zuerst die von den verschiedenen Melkanlagen zur Verfügung gestellten Informationen analysiert werden. Die Beschreibung der Daten der verschiedenen Anbieter sind in separaten Dokumenten abgelegt.
